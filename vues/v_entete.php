	...
	text-shadow: 0 1px 0 #eee,
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav nav " >
                    <a class="nav-item nav-link text-white" style="" href="index.php?do=informations">Informations <span class="sr-only">(current)</span></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div href=index.php?do=accueil" class="col align-self-start">
